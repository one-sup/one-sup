...
export interface IOneSupConnectorConfigState extends ITeamsBaseComponentState {
...
export interface IOneSupConnectorConfigProps {
}
...
/**
 * Implementation of the oneSupConnector Connector connect page
 */
export class OneSupConnectorConfig extends TeamsBaseComponent<IOneSupConnectorConfigProps, IOneSupConnectorConfigState> {
        ...
        if (await this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/oneSupConnector/config.html?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}`,
