...
export interface ISupBotTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ISupBotTabRemoveProps {

}

/**
 * Implementation of Sup Bot remove page
 */
export class SupBotTabRemove  extends TeamsBaseComponent<ISupBotTabRemoveProps, ISupBotTabRemoveState> {
