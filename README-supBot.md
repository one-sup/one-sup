...
3. Give the bot a handle (ex: `supBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://onesup.azurewebsites.net/api/messages`
